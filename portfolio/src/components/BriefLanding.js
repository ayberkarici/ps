  ...
  return (
    <div className="briefLanding">
      ...
      <div className="letsMeetBox">
        <span className="animate__animated animate__slideInLeft">Let's</span>
        <span className="animate__animated animate__slideInLeft">Meet</span>
      </div>
        
            <div
              className={props.windowPos ? "ca3-scroll-down-link ca3-scroll-down-arrow " : "deActivate ca3-scroll-down-link ca3-scroll-down-arrow" } 
